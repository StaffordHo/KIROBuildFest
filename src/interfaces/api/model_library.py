...
MODEL_CATALOG: list[ModelEntry] = [
    ...
    ModelEntry(
        id="r2d2",
        name="R2D2 Robot",
        description="Classic articulated robot model. Great for basic simulation testing.",
    ...
    ModelEntry(
        id="humanoid",
        name="Humanoid Robot",
        description="Full humanoid model for bipedal locomotion and whole-body control research.",
        category=RobotCategory.HUMANOID,
        manufacturer="PyBullet",
        dof=17,
        source_url="https://raw.githubusercontent.com/bulletphysics/bullet3/master/examples/pybullet/gym/pybullet_data/humanoid/humanoid.urdf",
